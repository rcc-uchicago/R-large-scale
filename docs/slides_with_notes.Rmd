...
and 18 GB of memory (replace `pi-hsimpson` with the account you have
access to):
...
> should also be already installed on midway3).
>
...
We can also develop an sbatch script that take command-line
arguments:
