...
+ *If you have an RCC account:* I assume you already know how to
  connect. Please use any way you prefer. See:
  https://rcc.uchicago.edu/docs/connecting

+ *If you do not have an RCC account:* I will provide you with a
  Yubikey, which will give you guest access (see the next slide).

Connecting using the Yubikeys
=============================

Download workshop packet to home directory on midway2
=====================================================

Once you have connected to a midway2 login node, download the workshop
packet (this is a *git repository*) to your home directory on the
cluster (**note:** there are no spaces in the URL):
