...
> Instructor nodes: We will use the genetic data only.
...
geno <- read.csv("regmap.csv")
```

> Instructor notes: Before loading the data into R, take a quick look
> at the CSV file.
...
```{r import-data-readr}
geno <- read_csv("call_method_75_TAIR9.csv",skip = 1)
